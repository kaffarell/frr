...
DEFPY (vtysh_ping,
       vtysh_ping_cmd,
       "ping WORD$dst [-I <A.B.C.D|X:X::X:X|WORD>$source] [-c (1-1000)$count] [-dontfragment]$dontfragment",
       "Send echo messages\n"
...
ALIAS(vtysh_ping, vtysh_ping_ip_cmd, "ping ip WORD$dst [-I <A.B.C.D|X:X::X:X|WORD>$source] [-c (1-1000)$count] [-dontfragment]$dontfragment",
      "Send echo messages\n"
      "IP echo\n"
      "Ping destination address or hostname\n"
      "Source interface or address\n"
...
DEFPY (vtysh_ping6,
       vtysh_ping6_cmd,
       "ping ipv6 WORD$dst [-I <A.B.C.D|X:X::X:X|WORD>$source] [-c (1-1000)$count] [-dontfragment]$dontfragment",
       "Send echo messages\n"
       "IPv6 echo\n"
       "Ping destination address or hostname\n"
       "Source interface or address\n"
